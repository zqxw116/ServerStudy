...
namespace DummyClient
{
    ...
    class SeverSession : Session
    {
        public override void OnConnected(EndPoint _endPoint)
        {
            ...
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 101, level =1, duration = 3f});
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 102, level =2, duration = 4f});
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 103, level =3, duration = 5f});
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 104, level =4, duration = 6f});
